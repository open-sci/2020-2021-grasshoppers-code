...
python tutorial.py
```
This command will launch our cleaning procedure on the dataset "invalid_dois.csv" in the dataset folder. This dataset is provided on public license in ([Peroni, 2021](http://doi.org/10.5281/zenodo.4625300)).
...
## Results
A visualization of the results of our experiment on the paper's dataset as well as a comparison with the results obtained by applying a procedure derived from ([Xu et al., 2019](https://doi.org/10.1007/s11192-019-03162-4)) on the same data are available in https://open-sci.github.io/2020-2021-grasshoppers-code/.
## References
